...
# Extended task validation — GPU 0 (3 tasks: boil, melt, find-living-thing)
# 3 tasks × 20 episodes × 2 conditions = 120 episode runs
...
echo "=========================================="
echo "Extended Task Validation — GPU 0"
echo "Tasks: ${#TASKS[@]}"
