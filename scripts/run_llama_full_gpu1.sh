...
# D118: Llama-3.1-8B full cross-model replication — GPU 1 (5 tasks)
# 5 tasks × 20 episodes × 2 conditions = 200 episode runs
# Each episode pair ~4.7 min → ~7.8 hours estimated
...
echo "=========================================="
echo "D118: Llama-3.1-8B Full Cross-Model — GPU 1"
echo "Tasks: ${#TASKS[@]}"
