...
# D118: Llama-3.1-8B full cross-model replication — GPU 0 (6 tasks)
# 6 tasks × 20 episodes × 2 conditions = 240 episode runs
# Each episode pair ~4.7 min → ~9.4 hours estimated
...
OUTPUT_DIR="results/llama_cross_model_full"
GPU_ID=0
EPISODES=20
...
echo "=========================================="
echo "D118: Llama-3.1-8B Full Cross-Model — GPU 0"
echo "Tasks: ${#TASKS[@]}"
...
echo ""
echo "=== PER-TASK DEATH SUMMARY (GPU 0) ==="
for TASK in "${TASKS[@]}"; do
