...
# D118: Llama-3.1-8B-Instruct full ScienceWorld replication (GPU 1)
# 5 tasks × 20 episodes × 2 conditions (always-internal + always-deterministic)
...
echo "=========================================="
echo "D118: Llama-3.1-8B Full Replication (GPU 1)"
echo "Tasks: ${#TASKS[@]}"
echo "Episodes per task: $EPISODES"
echo "Model: $MODEL_PATH"
echo "Output: $OUTPUT_DIR"
echo "GPU: $GPU_ID (CUDA_VISIBLE_DEVICES=1)"
echo "Seed: $SEED"
echo "Start: $(date)"
echo "=========================================="
